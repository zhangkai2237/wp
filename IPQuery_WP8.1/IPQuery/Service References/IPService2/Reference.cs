...
// 
namespace IPQuery.IPService2 {
    
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://WebXml.com.cn/", ConfigurationName="IPService2.IpAddressSearchWebServiceSoap")]
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IpAddressSearchWebServiceSoapChannel : IPQuery.IPService2.IpAddressSearchWebServiceSoap, System.ServiceModel.IClientChannel {
    }
    ...
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class IpAddressSearchWebServiceSoapClient : System.ServiceModel.ClientBase<IPQuery.IPService2.IpAddressSearchWebServiceSoap>, IPQuery.IPService2.IpAddressSearchWebServiceSoap {
        ...
        System.IAsyncResult IPQuery.IPService2.IpAddressSearchWebServiceSoap.BegingetCountryCityByIp(string theIpAddress, System.AsyncCallback callback, object asyncState) {
            return base.Channel.BegingetCountryCityByIp(theIpAddress, callback, asyncState);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        string[] IPQuery.IPService2.IpAddressSearchWebServiceSoap.EndgetCountryCityByIp(System.IAsyncResult result) {
        ...
        private System.IAsyncResult OnBegingetCountryCityByIp(object[] inValues, System.AsyncCallback callback, object asyncState) {
            ...
            return ((IPQuery.IPService2.IpAddressSearchWebServiceSoap)(this)).BegingetCountryCityByIp(theIpAddress, callback, asyncState);
        }
        
        private object[] OnEndgetCountryCityByIp(System.IAsyncResult result) {
            string[] retVal = ((IPQuery.IPService2.IpAddressSearchWebServiceSoap)(this)).EndgetCountryCityByIp(result);
            return new object[] {
                    retVal};
        }
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.IAsyncResult IPQuery.IPService2.IpAddressSearchWebServiceSoap.BegingetGeoIPContext(System.AsyncCallback callback, object asyncState) {
            return base.Channel.BegingetGeoIPContext(callback, asyncState);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        string[] IPQuery.IPService2.IpAddressSearchWebServiceSoap.EndgetGeoIPContext(System.IAsyncResult result) {
        ...
        private System.IAsyncResult OnBegingetGeoIPContext(object[] inValues, System.AsyncCallback callback, object asyncState) {
            return ((IPQuery.IPService2.IpAddressSearchWebServiceSoap)(this)).BegingetGeoIPContext(callback, asyncState);
        }
        
        private object[] OnEndgetGeoIPContext(System.IAsyncResult result) {
            string[] retVal = ((IPQuery.IPService2.IpAddressSearchWebServiceSoap)(this)).EndgetGeoIPContext(result);
            return new object[] {
                    retVal};
        }
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.IAsyncResult IPQuery.IPService2.IpAddressSearchWebServiceSoap.BegingetVersionTime(System.AsyncCallback callback, object asyncState) {
            return base.Channel.BegingetVersionTime(callback, asyncState);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        string IPQuery.IPService2.IpAddressSearchWebServiceSoap.EndgetVersionTime(System.IAsyncResult result) {
        ...
        private System.IAsyncResult OnBegingetVersionTime(object[] inValues, System.AsyncCallback callback, object asyncState) {
            return ((IPQuery.IPService2.IpAddressSearchWebServiceSoap)(this)).BegingetVersionTime(callback, asyncState);
        }
        
        private object[] OnEndgetVersionTime(System.IAsyncResult result) {
            string retVal = ((IPQuery.IPService2.IpAddressSearchWebServiceSoap)(this)).EndgetVersionTime(result);
            return new object[] {
                    retVal};
        }
        ...
        protected override IPQuery.IPService2.IpAddressSearchWebServiceSoap CreateChannel() {
            return new IpAddressSearchWebServiceSoapClientChannel(this);
        }
        
        private class IpAddressSearchWebServiceSoapClientChannel : ChannelBase<IPQuery.IPService2.IpAddressSearchWebServiceSoap>, IPQuery.IPService2.IpAddressSearchWebServiceSoap {
            
            public IpAddressSearchWebServiceSoapClientChannel(System.ServiceModel.ClientBase<IPQuery.IPService2.IpAddressSearchWebServiceSoap> client) : 
                    base(client) {
            }
