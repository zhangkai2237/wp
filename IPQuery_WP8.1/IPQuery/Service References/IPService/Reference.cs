...
namespace IPQuery.IPService {
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IpAddressSearchWebServiceSoapChannel : IPQuery.IPService.IpAddressSearchWebServiceSoap, System.ServiceModel.IClientChannel {
    }
    ...
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class IpAddressSearchWebServiceSoapClient : System.ServiceModel.ClientBase<IPQuery.IPService.IpAddressSearchWebServiceSoap>, IPQuery.IPService.IpAddressSearchWebServiceSoap {
        ...
        System.IAsyncResult IPQuery.IPService.IpAddressSearchWebServiceSoap.BegingetCountryCityByIp(string theIpAddress, System.AsyncCallback callback, object asyncState) {
            return base.Channel.BegingetCountryCityByIp(theIpAddress, callback, asyncState);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        string[] IPQuery.IPService.IpAddressSearchWebServiceSoap.EndgetCountryCityByIp(System.IAsyncResult result) {
        ...
        private System.IAsyncResult OnBegingetCountryCityByIp(object[] inValues, System.AsyncCallback callback, object asyncState) {
            ...
            return ((IPQuery.IPService.IpAddressSearchWebServiceSoap)(this)).BegingetCountryCityByIp(theIpAddress, callback, asyncState);
        }
        
        private object[] OnEndgetCountryCityByIp(System.IAsyncResult result) {
            string[] retVal = ((IPQuery.IPService.IpAddressSearchWebServiceSoap)(this)).EndgetCountryCityByIp(result);
            return new object[] {
                    retVal};
        }
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.IAsyncResult IPQuery.IPService.IpAddressSearchWebServiceSoap.BegingetGeoIPContext(System.AsyncCallback callback, object asyncState) {
            return base.Channel.BegingetGeoIPContext(callback, asyncState);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        string[] IPQuery.IPService.IpAddressSearchWebServiceSoap.EndgetGeoIPContext(System.IAsyncResult result) {
        ...
        private System.IAsyncResult OnBegingetGeoIPContext(object[] inValues, System.AsyncCallback callback, object asyncState) {
            return ((IPQuery.IPService.IpAddressSearchWebServiceSoap)(this)).BegingetGeoIPContext(callback, asyncState);
        }
        
        private object[] OnEndgetGeoIPContext(System.IAsyncResult result) {
            string[] retVal = ((IPQuery.IPService.IpAddressSearchWebServiceSoap)(this)).EndgetGeoIPContext(result);
            return new object[] {
                    retVal};
        }
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.IAsyncResult IPQuery.IPService.IpAddressSearchWebServiceSoap.BegingetVersionTime(System.AsyncCallback callback, object asyncState) {
            return base.Channel.BegingetVersionTime(callback, asyncState);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        string IPQuery.IPService.IpAddressSearchWebServiceSoap.EndgetVersionTime(System.IAsyncResult result) {
        ...
        private System.IAsyncResult OnBegingetVersionTime(object[] inValues, System.AsyncCallback callback, object asyncState) {
            return ((IPQuery.IPService.IpAddressSearchWebServiceSoap)(this)).BegingetVersionTime(callback, asyncState);
        }
        
        private object[] OnEndgetVersionTime(System.IAsyncResult result) {
            string retVal = ((IPQuery.IPService.IpAddressSearchWebServiceSoap)(this)).EndgetVersionTime(result);
            return new object[] {
                    retVal};
        }
        ...
        protected override IPQuery.IPService.IpAddressSearchWebServiceSoap CreateChannel() {
            return new IpAddressSearchWebServiceSoapClientChannel(this);
        }
        
        private class IpAddressSearchWebServiceSoapClientChannel : ChannelBase<IPQuery.IPService.IpAddressSearchWebServiceSoap>, IPQuery.IPService.IpAddressSearchWebServiceSoap {
            
            public IpAddressSearchWebServiceSoapClientChannel(System.ServiceModel.ClientBase<IPQuery.IPService.IpAddressSearchWebServiceSoap> client) : 
                    base(client) {
            }
